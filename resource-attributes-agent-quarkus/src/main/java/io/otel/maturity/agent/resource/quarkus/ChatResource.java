...
import io.otel.maturity.agent.resource.quarkus.model.ChatRequest;
...
public class ChatResource {
    ...
    private static final String AGENT_INSTRUCTIONS = """
            # Resource Attributes & Configuration Agent

            You are the **Resource Attributes & Configuration Agent** for the OpenTelemetry Maturity Evaluation pipeline.

            Your responsibility is to evaluate Dimension 3 (Resource Attributes & Configuration) of the OpenTelemetry Support
            Maturity Model for the given CNCF project. Activate the `dimension-3-resource-attributes` skill, passing the
