...
import io.otel.maturity.agent.tracing.quarkus.model.ChatRequest;
...
public class ChatResource {
    ...
    private static final String AGENT_INSTRUCTIONS = """
            ...
            Maturity Model for the given CNCF project. Activate the `dimension-4-trace-modeling` skill, passing the
