package io.otel.maturity.agent.install.controller;

import io.otel.maturity.agent.install.model.ChatRequest;
...
public class ChatController {
    ...
    public Flux<String> chat(@RequestBody ChatRequest request) {
        ...
        userPrompt.append("The CNCF project to install is: ")
        ...
        return chatClient.prompt()
                .advisors(advisor)
                .system("The Kubernetes cluster to use for this installation is: " + request.clusterName())
